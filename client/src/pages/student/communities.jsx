...
import { Users, MessageSquare, Loader2, CheckCircle, Search, TrendingUp, Filter, ArrowRight, Sparkles, Globe, Zap } from "lucide-react";
...
export default function Communities() {
  ...
  // Show message when no communities exist in database
    ...
    <Card key={community.id} className="flex flex-col hover:shadow-xl hover:border-primary/50 transition-all duration-300 group bg-white overflow-hidden">
      <CardHeader className="pb-3 relative">
        ...
        <CardDescription className="line-clamp-2 mt-2 text-gray-600 text-sm leading-relaxed">
          {community.description || "Join this community to connect with others and share knowledge."}
        </CardDescription>
      </CardHeader>
      <CardContent className="mt-auto pt-0">
        <div className="flex items-center justify-between text-sm text-gray-600 mb-4 pb-4 border-b border-gray-100">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">{community.postCount || 0} posts</span>
          </div>
        </div>
        ...
        <div className="relative bg-gradient-to-br from-primary via-primary/90 to-purple-600 rounded-2xl p-8 md:p-10 text-white shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-semibold uppercase tracking-wider opacity-90">Discover & Connect</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-3 leading-tight">
              Communities
            </h1>
            <p className="text-lg text-white/90 max-w-2xl leading-relaxed">
              Join vibrant communities, connect with like-minded peers, share knowledge, and grow together in your areas of interest.
            </p>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/30">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs opacity-90">Your Communities</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <Card className="border-2 border-dashed border-gray-200">
                <CardContent className="p-16 text-center">
                  ...
                  <p className="text-gray-500 max-w-md mx-auto mb-6">
                    Explore and join communities to connect with peers and share knowledge
                  </p>
                  <Button 
                    onClick={() => {
                      setActiveTab("all");
              ...
              <Card className="border-2 border-dashed border-green-200 bg-green-50/30">
                <CardContent className="p-16 text-center">
                  ...
                  <p className="text-gray-600 max-w-md mx-auto">
                    Fantastic! You're now part of all communities. Keep engaging and contributing!
                  </p>
                </CardContent>
              </Card>
            ) : (
